<script>
    ...
    <div class="bg-gray-900">
        ...
        <div class="relative isolate overflow-hidden pt-6">
          <img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=2830&q=80&blend=111827&sat=-100&exp=15&blend-mode=multiply" alt="" class="absolute inset-0 -z-10 size-full object-cover">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-16">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            <div class="overflow-hidden rounded-2xl shadow-xl ring-1 ring-gray-200">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.001924246237!2d107.63708791074282!3d-6.52143746372805!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69157b1927e5a3%3A0x1182e42524259d7!2sKaos%20Polos%20Glam%20Stitch!5e0!3m2!1sid!2sid!4v1745405537675!5m2!1sid!2sid"
                width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy"
                class="w-full h-[400px] rounded-2xl border-none">
              </iframe>
            </div>
              ...
              <div class="flex items-start gap-4">
                <div class="flex-shrink-0">
                  <img src="https://img.freepik.com/free-vector/location-pin-map-glyph_78370-1576.jpg?ga=GA1.1.1868222757.1738365469&semt=ais_hybrid&w=740"
                    alt="Icon Lokasi" class="h-14 w-14 object-contain rounded-xl shadow-md">
                </div>
                <div>
                  <h3 class="text-lg font-semibold text-gray-900">Alamat</h3>
                  <p class="text-gray-600">Kampung Dayacipta, Tanggulun Bar., Kec. Kalijati, Kabupaten Subang, Jawa Barat 41271</p>
                </div>
              </div>
              ...
              <div class="flex items-start gap-4">
                <div class="flex-shrink-0">
                  <img src="https://media.istockphoto.com/id/1283403359/id/vektor/ikon-waktu-di-latar-belakang-transparan.jpg?s=612x612&w=0&k=20&c=foEv6n4528X0AkgcQZBX6TqWlZAOezpBEgoDRS-5LDo="
                    alt="Icon Jam" class="h-14 w-14 object-contain rounded-xl shadow-md">
                </div>
                <div>
                  <h3 class="text-lg font-semibold text-gray-900">Jam Operasional</h3>
                  <p class="text-gray-600">Senin - Jum'at, 09.00 - 17.00 WIB</p>
