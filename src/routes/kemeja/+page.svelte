    ...
    <div class="bg-gray-900">
        <header class="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-screen-lg bg-white shadow-sm border border-gray-300 rounded-full px-4">
          <nav class="flex items-center justify-between px-4 py-2">
            ...
            <label for="menu-toggle" class="z-50 bg-white/80 backdrop-blur-lg p-4 rounded-full cursor-pointer lg:hidden hover:bg-white/90">
        ...
        <div class="relative isolate overflow-hidden pt-6">
          <img src="https://img.freepik.com/free-photo/dressmaker-is-measuring-fabric-with-meter-his-studio-man-is-looking-camera-he-is-wearing-denim-cap-glasses-there-are-lot-sewing-tools-background_613910-21802.jpg"
          ...
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-24">
              ...
              <div class="text-center">
                <h1 class="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">Produk Kemeja Glam Stitch</h1>
          ...
          <main class="pt-10 sm:pt-8">
            ...
            <div class="mx-auto mt-6 max-w-2xl px-4 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-16 space-y-4 lg:space-y-0">
              ...
              <div class="grid grid-cols-1 gap-y-4">
                <img src="https://media.istockphoto.com/id/162368681/id/foto/potret-fashion-pemuda-berbaju-hitam.jpg?s=612x612&w=0&k=20&c=LZY5r_8zNI0IONWIMUzVQMInfxhqBgbk__1OfIq-ni0="
            ...
            <div class="mx-auto max-w-2xl px-4 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto_auto_1fr] lg:gap-x-8 lg:px-16 lg:pt-16">
              <div class="lg:col-span-2 lg:pr-8">
                <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Kemeja Glam Stitch</h1>
              </div>
            ...
            <section aria-labelledby="related-products-heading" class="bg-white">
              <div class="mx-auto max-w-2xl px-16 py-24 sm:px-16 lg:max-w-7xl lg:px-16">
                ...
                <p class="mt-2 text-lg text-gray-400 text-center">Lihat produk Glam Stitch lainnya yang bisa kamu sukai. Tersedia berbagai pilihan stylish untuk setiap kesempatan.</p>
                <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
        
                  <!-- Produk 1 -->
                  <div class="group relative">
                    <img src="assets/image/kemeja.jpg" alt="Kaos Glam Stitch warna hitam." class="aspect-square w-full rounded-md bg-gray-200 object-cover group-hover:opacity-75 lg:aspect-auto lg:h-80">
                  ...
                  <!-- Produk 2 -->
                  <div class="group relative">
                    <img src="https://i.pinimg.com/474x/dc/0c/f8/dc0cf89c241e8da2ec335ab995fbfd3a.jpg" alt="Kaos Glam Stitch warna putih." class="aspect-square w-full rounded-md bg-gray-200 object-cover group-hover:opacity-75 lg:aspect-auto lg:h-80">
                    <div class="mt-4 flex justify-between">
                      <div>
                        <h3 class="text-sm text-gray-700">
                  ...
                  <!-- Produk 3 -->
                  <div class="group relative">
                    <img src="https://img.freepik.com/premium-photo/mens-black-short-sleeve-shirt_53876-1021210.jpg?ga=GA1.1.1868222757.1738365469&w=740" alt="Kaos Glam Stitch warna charcoal." class="aspect-square w-full rounded-md bg-gray-200 object-cover group-hover:opacity-75 lg:aspect-auto lg:h-80">
                    <div class="mt-4 flex justify-between">
                      <div>
                        <h3 class="text-sm text-gray-700">
